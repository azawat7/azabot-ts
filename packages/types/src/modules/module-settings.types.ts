import { LevelModuleSettings, LevelModuleSettingKeys } from "./level-module.types";

export interface ModuleSettings {
  levelModule: LevelModuleSettings;
}

// Union of all possible setting keys across all modules
export type AllSettingKeys = LevelModuleSettingKeys;
